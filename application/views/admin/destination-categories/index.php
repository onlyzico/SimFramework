  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row data-actions mb-15">
        <div class="col-md-12">
          <?php if ( current_user_can( 'admin_add_destination_category' ) ) { ?>
            <a class="btn btn-primary" href="<?php echo admin_url() . '/destinations/categories/add'; ?>" style="margin-right: 15px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Baru</a>
          <?php } ?>

          <select class="action select2" style="width: 150px;">
            <option value="">Aksi Masal</option>
            <?php if ( current_user_can( 'admin_delete_destination_category' ) ) { ?>
              ...
              <table id="datatable" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <?php if ( current_user_can( 'admin_edit_destination_category' ) ) { ?>
                      <th width="7%"></th>
                    <?php } ?>
                  </tr>
                </thead>
  ...
  <?php
    if ( current_user_can( 'admin_delete_destination_category' ) ) {
      echo admin_create_delete_modal( [
        'title' => 'Hapus kategori destinasi terpilih',
        'body' => 'Apakah anda yakin untuk menghapus kategori destinasi terpilih?<br />Semua data terkait kategori destinasi terpilih akan dihapus permanen!'
      ] );
    }
  ?>
