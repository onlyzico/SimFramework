  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row data-actions mb-15">
        <div class="col-md-12">
          <?php if ( current_user_can( 'admin_add_category' ) ) { ?>
          ...
          <select class="action select2" style="width: 150px;">
            ...
            <?php if ( current_user_can( 'admin_delete_category' ) ) { ?>
              ...
              <table id="datatable" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <?php if ( current_user_can( 'admin_edit_category' ) ) { ?>
                      <th width="7%"></th>
                    <?php } ?>
                  </tr>
                </thead>
  ...
  <?php
    if ( current_user_can( 'admin_delete_category' ) ) {
      echo admin_create_delete_modal( [
        ...
        'body' => 'Apakah anda yakin untuk menghapus kategori terpilih?<br />Semua data terkait kategori terpilih akan dihapus permanen!'
      ] );
    }
  ?>
