  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row data-actions mb-15">
        <div class="col-md-12">
          <?php if ( current_user_can( 'admin_add_creative_economy_category' ) ) { ?>
          ...
          <select class="action select2" style="width: 150px;">
            ...
            <?php if ( current_user_can( 'admin_delete_creative_economy_category' ) ) { ?>
              ...
              <table id="datatable" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <?php if ( current_user_can( 'admin_edit_creative_economy_category' ) ) { ?>
                      <th width="7%"></th>
                    <?php } ?>
                  </tr>
                </thead>
  ...
  <?php
    if ( current_user_can( 'admin_delete_creative_economy_category' ) ) {
      echo admin_create_delete_modal( [
        'title' => 'Hapus kategori ekraf terpilih',
        'body' => 'Apakah anda yakin untuk menghapus kategori ekraf terpilih?<br />Semua data terkait kategori ekraf terpilih akan dihapus permanen!'
      ] );
    }
  ?>
