<?php include APP . '/views/admin/includes/header.php'; ?>
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo admin_url() . '/creative-economy'; ?>">Destinasi</a></li>
        <li><a href="<?php echo admin_url() . '/creative-economy/categories'; ?>">Kategori</a></li>
        <li class="active"><?php echo $aeo['breadcrumb_title']; ?></li>
      </ol>
    </section>

    <section class="content">
      <?php if ( $edit && current_user_can( 'admin_add_creative_economy_category' ) ) { ?>
        <div class="row mb-15">
          <div class="col-md-12">
            <a class="btn btn-primary" href="<?php echo admin_url() . '/creative-economy/categories/add'; ?>" style="margin-right: 15px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Baru</a>
          </div>
        </div>
      <?php } ?>
          ...
          <div class="box box-default mb-5">
            <form class="edit-form" role="form" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group form-group--image-upload">
                  ...
                  <div class="placeholder<?php echo ( $edit && $category['image'] ) ? ' show' : ''; ?>">
                    <?php if ( $edit && $category['image'] ) { ?>
                      <img src="<?php echo site_url() . '/uploads/creative-economy-categories/' . $category['image']; ?>" alt="" />
              ...
              <div class="box-footer">
                ...
                <?php if ( $edit && current_user_can( 'admin_delete_creative_economy_category' ) ) { ?>
  ...
  <?php
    if ( $edit && current_user_can( 'admin_delete_creative_economy_category' ) ) {
      echo admin_create_delete_modal( [
        'title' => 'Hapus kategori ekraf',
        'body' => 'Apakah anda yakin untuk menghapus kategori ekraf ini? Semua data terkait kategori ekraf ini akan dihapus permanen!'
      ] );
    }
  ?>
