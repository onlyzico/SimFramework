      ...
      <div class="row data-actions mb-15">
        <div class="col-md-12">
          <select class="action select2" style="width: 150px;">
            ...
            <?php if ( current_user_can( 'admin_delete_message' ) ) { ?>
              ...
              <table id="datatable" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <?php if ( current_user_can( 'admin_message' ) ) { ?>
                      <th width="7%"></th>
                    <?php } ?>
                  </tr>
                </thead>
  ...
  <?php
    if ( current_user_can( 'admin_delete_message' ) ) {
      echo admin_create_delete_modal( [
        ...
        'body' => 'Apakah anda yakin untuk menghapus pesan terpilih?<br />Semua data terkait pesan terpilih akan dihapus permanen!'
      ] );
    }
  ?>
