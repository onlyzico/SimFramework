      ...
      <div class="row data-actions mb-15">
        <div class="col-md-12">
          ...
          <select class="action select2" style="width: 150px;">
            ...
            <?php if ( current_user_can( 'admin_delete_destination' ) ) { ?>
              ...
              <table id="datatable" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <?php if ( current_user_can( 'admin_edit_destination' ) ) { ?>
                      <th width="7%"></th>
                    <?php } ?>
                  </tr>
                </thead>
  ...
  <?php
    if ( current_user_can( 'admin_delete_destination' ) ) {
      echo admin_create_delete_modal( [
        'title' => 'Hapus destinasi terpilih',
        'body' => 'Apakah anda yakin untuk menghapus destinasi terpilih?<br />Semua data terkait destinasi terpilih akan dihapus permanen!'
      ] );
    }
  ?>
